...
from api.mixins import CustomMixinHideModelViewSet
...
class PriceListConfigViewSet(CustomMixinHideModelViewSet):
    """
    MEH: Price List Config Model viewset,
    (hidden viewset method)
    """
    ...
    def config_info(self, request):
        ...
        if request.method in ['PUT', 'PATCH']:
            return self.custom_update(obj, request.data, partial=(request.method == 'PATCH'))
